    ...
    <div className="min-h-screen flex flex-col md:flex-row">
      ...
      <div className="hidden md:flex flex-col justify-center items-start p-12 lg:p-24 w-1/2 bg-gradient-to-br from-purple-700 to-purple-900 text-white">
        ...
        <h1 className="text-4xl lg:text-5xl font-bold mb-6 leading-tight">
          Email Marketing<br />এখন সহজ, বাংলায়
        </h1>
        
        <div className="space-y-4 text-purple-100 mt-8">
          {[
            'বাংলা ইন্টারফেস ও সহজে ব্যবহারযোগ্য',
            'AI দিয়ে আকর্ষণীয় ইমেইল তৈরি',
            'সঠিক অ্যানালিটিক্স ও রিপোর্ট',
          ].map((feature, idx) => (
      ...
      <div className="flex-1 flex flex-col justify-center items-center p-8 bg-gray-50 dark:bg-gray-950">
        <div className="w-full max-w-md bg-white dark:bg-gray-900 rounded-3xl shadow-xl border border-gray-100 dark:border-gray-800 p-8 transition-all duration-300 hover:shadow-2xl">
          ...
          <div className="text-center mb-8">
            ...
            <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-2">লগইন করুন</h2>
            <p className="text-gray-500 dark:text-gray-400">আপনার ড্যাশবোর্ডে ফিরে যান</p>
          </div>
          ...
          <form className="space-y-5" onSubmit={(e) => e.preventDefault()}>
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center">
                ...
                <Link href="/forgot-password" className="text-sm font-medium text-purple-600 hover:text-purple-500 dark:text-purple-400">
